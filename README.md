...
**Note:**
To check if the path has /usr/local/bin, run the echo $PATH command

 If the path does not contain the above not, use the following command to update the $PATH:
